...
struct real add_real_int (struct real x, int64_t n); // returns real x +  int n
struct real sub_real_int (struct real x, int64_t n); // returns real x - int n
struct real mul_real_real (struct real x, struct real y); // returns real x * real y
struct real mul_real_int (struct real x, int64_t n); // returns real x * int n
struct real div_real_real (struct real x, struct real y); // returns real x /real y
struct real div_real_int (struct real x, int64_t n);// returns real x / int n
